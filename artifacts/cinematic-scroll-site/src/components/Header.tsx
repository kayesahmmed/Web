      ...
      <div className="flex items-center gap-2 sm:gap-3 pl-10 sm:pl-16 ml-auto z-20 shrink-0">
        ...
        {currentUser ? (
          ...
          <button
            ...
            className="group relative flex items-center gap-1.5 px-5 h-10 rounded-full font-['Orbitron',sans-serif] font-bold text-xs sm:text-sm tracking-wide uppercase transition-all hover:scale-105 active:scale-95 cursor-pointer shadow-lg text-white overflow-hidden border border-[#00E5D1]/40"
            style={{ background: "linear-gradient(135deg, rgba(125,82,253,0.8) 0%, rgba(0,229,209,0.7) 100%)", backdropFilter: "blur(8px)" }}
          >
            ...
            <span className="inline relative z-10">Sign In</span>
          </button>
        )}
      </div>
    </header>
